# dwm_lut v5.0.0 — Windows 11 25H2 Support
### A fork of [lauralex/dwm_lut](https://github.com/lauralex/dwm_lut) (original by [ledoge](https://github.com/ledoge/dwm_lut))

## [Download v5.0.0 for Windows 11 25H2](https://github.com/DeDuplicate/dwm_lut/releases/latest)

> **v5.0.0** adds support for **Windows 11 25H2 (build 26200+)** where the DWM architecture changed significantly. If you are on an older Windows version, use the [upstream release](https://github.com/lauralex/dwm_lut/releases/latest/download/Release.zip) instead.
